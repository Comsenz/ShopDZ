...
use Org\Alipay\common\AopEncrypt;//加密方法
use Org\Alipay\common\EncryptParseItem;//加密方法
use Org\Alipay\common\Inflector;//加密方法
use Org\Alipay\common\SignData;//加密方法

class AopClient extends AopEncrypt {
	//应用ID
	public $appId;
	//私钥文件路径
	...
	public $encryptKey='SW8pCJ0AI5wuoh/IHfeaAA==';
	...
	*/
	public function pageExecute($request,$httpmethod = "POST") {
		...
		$request->getNotifyUrl() && $sysParams["notify_url"] = $request->getNotifyUrl();
		$request->getReturnUrl() && $sysParams["return_url"] = $request->getReturnUrl();
