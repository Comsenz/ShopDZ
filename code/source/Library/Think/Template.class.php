        ...
        if(C('LAYOUT_ON')) {
            if(false !== strpos($tmplContent,'{__NOLAYOUT__}')) { // 可以单独定义不使用布局
               ...
               // $layoutFile  =  THEME_PATH.C('LAYOUT_NAME').$this->config['template_suffix'];
				$layoutFile  =! C('LAYOUT_PATH')?THEME_PATH.C('LAYOUT_NAME').$this->config['template_suffix']:C('LAYOUT_PATH').C('LAYOUT_NAME').$this->config['template_suffix'];
                // 检查布局文件
        ...
        if($find) {
            ...
            if(!C('LAYOUT_ON') || C('LAYOUT_NAME') !=$array['name'] ) {
               ...
               // $layoutFile =   THEME_PATH.$array['name'].$this->config['template_suffix'];
				$layoutFile  = !C('LAYOUT_PATH')?THEME_PATH.$array['name'].$this->config['template_suffix']:C('LAYOUT_PATH').C('LAYOUT_NAME').$this->config['template_suffix'];
