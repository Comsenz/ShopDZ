...
class Model {
    ...
    public function startTrans() {
        $this->commit();
        $this->master(true)->db->startTrans();
    ...
    public function commit() {
        return $this->master(true)->db->commit();
    }
    ...
    public function rollback() {
        return $this->master(true)->db->rollback();
    }
     ...
     * @param string $type
     * @return \Think\Model
     * @auth byron sampson xiaobo.sun@qq.com
     */
