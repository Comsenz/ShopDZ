...
class WxRefundUser extends WxPayDataBase{
     ...
     public function __construct($openid,$amount,$partner_trade_no){
        ...
        $this->values['mch_appid']=get_wxpay_config('appid');//公众账号appid
        $this->values['mchid']=get_wxpay_config('mchid');//商户号
  ...
  public function curl_post_ssl($data) {
        ...
        $zs1= APP_ROOT.'/data/Attach/'.get_wxpay_config('sslcert_path');
        $zs2= APP_ROOT.'/data/Attach/'.get_wxpay_config('sslkey_path');
