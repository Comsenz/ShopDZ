...
use Common\PayMent\WxPay\WxPayConfig;
use Common\PayMent\WxPay\WxPayDataBase;
use Common\PayMent\WxPay\WxPayException;
use Common\PayMent\WxPay\WxPayResults;
/**
 * 
...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		$inputObj->SetAppid(get_wxpay_config('appid'));//公众账号ID
		$inputObj->SetMch_id(get_wxpay_config('mchid'));//商户号
	...
	{	
		...
		if($useCert == true){
			...
			curl_setopt($ch,CURLOPT_SSLCERT, APP_ROOT.'/data/Attach/'.get_wxpay_config('sslcert_path'));
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLKEY, APP_ROOT.'/data/Attach/'.get_wxpay_config('sslkey_path'));
		}
		//post提交方式
