...
<div class="iframeCon">
    <ul class="transverse-nav">
        <li class="activeFour"><a  href="javascript:;"><span>新增优惠券</span></a></li>
    </ul>
    <div class="white-bg text-c">
        <div class="coupon-con">
            <div class="coupon-left">
                        ...
                        <div class="coupon-box-top">
                            <div class="coupon-top-con">
                                <div class="zoom">
                                    ...
                                    <p class="count-limit right">每人限领<span class="change-eachlimit" change-default="xx">XX</span>张</p>
                                </div>
                                <div class="zoom couponMoney-box">
                                    ...
                                    <div class="right">
                                        <p class="coupon-share coupon-point"><span class="change-points coupon-red" change-default="xxx">xxx</span>积分兑换<p>
                                        <p class="coupon-points-none   coupon-share coupon-share1" style="display: none">免费领取</p>
                ...
                <div class="coupon-box wx-coupon" style="display: none">
                    <div class="coupon-box-det wx-coupon-det">
                        <div class="coupon-box-top coupon-box-top_wx">
                            <div class="coupon-top-con">
                                <div class="zoom">
                                    <p class=" coupon-subtit left change-title" change-default="">微信卡券标题</p>
            ...
            <div class="coupon-right">
                 <div class="couponR-con">
                    <div class="coupon-edit-box">
                        <form method="post" class="form-horizontal" name="redpacke_form" id="redpacke_form" action="{:U('Coupon/add')}">
                                ...
                                <td>
                                    <div class="coupon-full">
                                        <div class="release-price coupon-table-num left full-num">
                                            <input type="text" class="price-inp left changenow" change-key="limit" localrequired="intval;empty;gt:rpacket_t_price" name="rpacket_t_limit"  value="{$info.rpacket_t_limit}" id="rpacket_t_limit"/>
                                            <span class="price-unit left">元</span>
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="button-holder coupon-holder marginT5">
                                        <p class="radiobox"><input type="radio" id="radio-1-5" data-type="rpacket_t_wx" name="rpacket_t_wx" value="1" class="regular-radio one"><label for="radio-1-5"></label><span class="radio-word black-font">启用</span></p>
                                    </div>
                                    <p class="coupon-remind">需要先开通微信公众号卡券权限，同步至微信卡包后，需等待微信审核通过，才能领取。</p>
                                </td>
                            </tr>
                            <tr class="wxcolor" style="display: none">
                        ...
                        <table class="coupon-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="time-box coupon-time-box"><input type="text" localrequired="empty;time:start" class="coupon-inp changenow" readonly="" change-key="end" name="end" <?php echo $info['rpacket_t_end_date'] ? 'value="'.@date('Y-m-d H:i:s',$info['rpacket_t_end_date']).'"' : '';?> id="end" ><i class="timeinp-icon"></i></p>
