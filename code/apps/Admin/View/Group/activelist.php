<div class="tipsbox">
	...
	<ol class="tips-list" id="tips-list">
		...
		<li>4.拼团活动地址为http://xxxx.com/wap/fightGroupList.html。</li>
	</ol>
</div>
<div class="iframeCon">
<div class="iframeMain">
       <ul class="transverse-nav">
        <li class="{$type==''?'activeFour':''}"><a href="{:U('Group/activelist')}"><span>活动列表</span></a></li>
		<li class="{$type=='10'?'activeFour':''}"><a href="{:U('Group/grouplist')}?type=10"><span>开团列表</span></a></li>
		<li class="{$type=='20'?'activeFour':''}"><a href="{:U('Group/joinlists')}?type=20"><span>参团列表</span></a></li>
    </ul>
    <div class="white-bg">
        <div class="table-titbox">
            <h1 class="table-tit left boxsizing">活动列表</h1>
            <ul class="operation-list left">
                <li class="add-li"  title="新增活动" ><a  href="{:U('Group/group')}"><span><i  class="operation-icon add-icon"></i></a></span></li>
                <li class="refresh-li" onclick="location.reload();" ><a  href="#"><span><i  class="operation-icon refresh-icon"></i></span></a></li>
            </ul>
            <div class="search-box1 right">
            <form  method="get" class="form-horizontal"   action="<?php echo U('Group/activelist');?>" name="Search_form"  >
                            ...
                            <div class="table-iconbox">
                                ...
                                <div class="table-icon left setting-sele-par">
                                    ...
                                    <ul class="setting-sele-con remind-layer">
                                        <li><a href="<?php echo U('Group/group',array('id'=>$v['id']));?>"> 编辑活动</a></li>
                                        <li><a href="<?php echo U('Group/grouplist',array('active_id'=>$v['id']));?>"> 开团列表</a></li>
										<li><a href="<?php echo U('Group/joinlists',array('active_id'=>$v['id']));?>"> 参团列表</a></li>
                                    </ul>
                                </div>
                            </div>
                        </td>
