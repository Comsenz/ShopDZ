...
<div class="iframeMain">
       <ul class="transverse-nav">
        <li ><a href="{:U('Group/activelist')}"><span>活动列表</span></a></li>
		<li><a href="{:U('Group/grouplist')}?type=10"><span>开团列表</span></a></li>
		<li  class="activeFour"><a href="{:U('Group/joinlists')}?type=20"><span>参团列表</span></a></li>
    </ul>
    <div class="white-bg">
        <div class="table-titbox">
            ...
            <form  method="get" class="form-horizontal"   action="<?php echo U('Group/joinlists');?>" name="Search_form"  >
                            ...
                            <div class="table-iconbox">
                              ...
                              <div class="table-iconbox">
								<div class="edit-iconbox left edit-sele marginR10">
									<a href="<?php echo U('Group/detail',array('order_sn'=>$v['order_sn']));?>" class="edit-word table-icon-a"><i class="table-com-icon table-look-icon"></i><span class="gap">详情</span></a>
								</div>
							</div>
                            </div>
                        </td>
