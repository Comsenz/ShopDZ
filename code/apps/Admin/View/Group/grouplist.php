...
<div class="iframeMain">
       <ul class="transverse-nav">
		...
		<li class="activeFour"><a href="{:U('Group/grouplist')}?type=10"><span>开团列表</span></a></li>
		<li ><a href="{:U('Group/joinlists')}?type=20"><span>参团列表</span></a></li>
    </ul>
    <div class="white-bg">
        <div class="table-titbox">
            ...
            <form  method="get" class="form-horizontal"   action="<?php echo U('Group/grouplist');?>" name="Search_form"  >
							...
							<?php if(empty($v['status'])) { ?>
                                ...
                                <div class="table-icon left setting-sele-par">
                                    ...
                                    <ul class="setting-sele-con remind-layer">
                                        <li><a href="<?php echo U('Group/joinlists',array('group_id'=>$v['group_id']));?>"> 参团列表</a></li>
                                    </ul>
                                </div>
                            </div>
                        </td>
