		...
		<div class="iframeMain">
			...
			<div class="white-bg">
				<div class="details-box">
					...
					<div class="jurisdiction boxsizing">
						 <form action="<?=U('Spread/edit');?>" method="post" id='edit_form'>
					...
					<div class="btnbox3 boxsizing">
						<input id='edit_form_submit' type="button" class="btn1 radius3 btn3-btnmargin"  value="{$Think.lang.submit_btn}">
						<a type="button" href="<?=U('Spread/withdraw',array('status'=>1));?>" class="btn1 radius3 marginT10">返回列表</a>
					</div>
				</div>
			</div>
		</div>
