		...
		<div class="iframeMain">
			<ul class="transverse-nav">
				<li class="activeFour"><a href="javascript:;"><span>银行列表</span></a></li>
			</ul>
			<div class="white-bg">
				<div class="table-titbox">
					<h1 class="table-tit left boxsizing">银行列表</h1>
					<ul class="operation-list left">
						<li class="add-li"><a href="<?=U('/Spread/bank')?>"><span><i href="#" class="operation-icon add-icon"></i></span></a></li>
								...
								<td>
									<div class="table-iconbox">
										<div class="edit-iconbox left edit-sele marginR10">
											<a class="edit-word table-icon-a delbank" href ="javascript:;"  rel-href="<?=U('/Spread/delbank')?>" index="<?=$v['id']?>"><i class="table-com-icon table-dele-icon"></i><span class="gap">删除</span></a>
											</div>
								
										<div class="edit-iconbox left edit-sele marginR10">
											<a class="edit-word table-icon-a" href ="<?=U('/Spread/bank',array('id'=>$v['id']))?>"><i class="table-com-icon table-edit-icon"></i><span class="gap">编辑</span></a>
										</div>
									</div>
								</td>
								<td><?=$v['name']?></td>
