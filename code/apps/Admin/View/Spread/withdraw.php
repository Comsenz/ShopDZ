<!--内容开始-->
		...
		<div class="iframeMain">
			<ul class="transverse-nav">
				<li  <?php if($status ==''){ ?> class="activeFour" <?php }?> ><a href="<?=U('Spread/withdraw');?>"><span>全部</span></a></li>
				<li <?php if($status ==1){ ?> class="activeFour" <?php }?> ><a href="<?=U('Spread/withdraw',array('status'=>1));?>"><span>待审核</span></a></li>
				<li <?php if($status ==3){ ?> class="activeFour" <?php }?>><a  href="<?= U('Spread/withdraw',array('status'=>3));?>"><span>已同意</span></a></li>
				<li <?php if($status ==2){ ?> class="activeFour" <?php }?>><a   href="<?= U('Spread/withdraw',array('status'=>2));?>"><span>已拒绝</span></a></li>
			</ul>
			<div class="white-bg ">
				<div class="table-titbox">
					...
					<form action="<?=U('/Spread/withdraw',array('status'=>$status))?>" method="get" id='formid'>
					<div class="search-box1 right">
						<div class="search-boxcon boxsizing radius3 left">
							<select class="sele-com1 search-sele boxsizing" name="type" id="search_select">
                        		...
                        		<option value="member_mobile" <?php if($type =='member_mobile'){ ?> selected='selected' <?php }?>>会员账号</option>
									...
									<div class="table-iconbox">
										<?php if($status  == 1) {?>
											<div class="edit-iconbox left edit-sele marginR10">
												<a class="edit-word table-icon-a" href="<?=U('/Spread/edit',array('id'=>$v['cash_id'])) ?>"><i class="table-com-icon table-handle-icon"></i><span class="gap">待审核</span></a>
											</div>
										<?php }else if(in_array($status,array(2,3))){?>
											<div class="edit-iconbox left edit-sele marginR10">
												<a class="edit-word table-icon-a" href="<?=U('/Spread/show',array('id'=>$v['cash_id'])) ?>"><i class="table-com-icon table-look-icon"></i><span class="gap">查看</span></a>
											</div>
										<?php }?>
									</div>
								</td>
