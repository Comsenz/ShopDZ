					...
					<dl class="juris-dl boxsizing">
						...
						<dd class="left text-l">
							<div class="switch-box">
								<input type="checkbox" name="state" id="switch-radio" class="switch-radio" <if condition="$config['web_status'] eq 1 ">checked="checked" <else /> </if> <if condition="$config['web_status'] eq '' ">checked="checked" <else /> </if>/>
