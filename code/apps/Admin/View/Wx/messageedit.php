...
<div class="iframeMain">
	...
	<div class="white-bg ">
		<div class="tab-conbox">
			<form method="post" class="form-horizontal" name="memberForm" id="memberForm" action="{:U('Wx/messageedit')}" enctype="multipart/form-data">
				...
				<div class="jurisdiction boxsizing">
					...
					<dd class="left text-l">
						<textarea type="text" name="content" id = "wxkeywords" class="com-textarea1 radius3 boxsizing" placeholder="请输入文本内容"   localrequired="">{$message.wx_content}</textarea>
					...
					<dl class="juris-dl boxsizing">
						...
						<dd class="left text-l">
							<div class="switch-box">
								<input type="checkbox" name="states" id="switch-radio" class="switch-radio" <if condition="$message['wx_states']">checked="true" </if>/>
				...
				<div class="btnbox3 boxsizing">
					...
					<a class="btn1 radius3 marginT10 left" href="{:U('Wx/message')}">返回列表</a>
				</div>
