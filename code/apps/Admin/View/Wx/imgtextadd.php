				...
				<div class="jurisdiction boxsizing">
					...
					<dl class="juris-dl boxsizing data-dl">
						...
						<dd class="left text-l">
							...
							<p class="remind1 paddingB3">点击你要发布的图片</p>
						</dd>
						<div class="clear"></div>
					</dl>
	...
	$(function(){
		$('.showsearchbtn').click(function() {
			...
			var addconte = '<tr id="additem_'+itemnum+'" class="checkis_'+itemnum+'">' +
					'<td width="50"><input type="text" name="order[]" value="0" class="data-sort"></td>' +
					'<td width="270"><input type="text" name="title[]" value="" class="wx-inp" style="width: 240px" localrequired=""></td>'+
					'<td width="180"><input type="text" name="url[]" value="" class="wx-inp" style="width: 150px" localrequired=""></td>'+
					' <td width="262"> ' +
