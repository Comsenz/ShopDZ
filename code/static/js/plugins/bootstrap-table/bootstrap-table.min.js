...
function(a) {
    ...
    n.prototype.initContainer = function() {
        this.$container = a(['<div class="bootstrap-table">', '<div class="fixed-table-toolbar"></div>', "top" === this.options.paginationVAlign || "both" === this.options.paginationVAlign ? '<div class="fixed-table-pagination" style="clear: both;"></div>': "",'<div class="dashed1"></div>','<div class="form-group advanced-searchbox" id="data_5"><label class="font-noraml left time-label">范围选择</label><div class="input-daterange input-group left time1" id="datepicker"><input type="text" class="input-sm form-control com-inp2" name="start" value="2014-11-11" /><span class="input-group-addon left totime">到</span><input type="text" class="input-sm form-control com-inp2" name="end" value="2014-11-17" /></div></div>', '<div class="fixed-table-container">', '<div class="fixed-table-header"><table></table></div>', '<div class="fixed-table-body">', '<div class="fixed-table-loading">', this.options.formatLoadingMessage(), "</div>", "</div>", '<div class="fixed-table-footer"><table><tr></tr></table></div>', "bottom" === this.options.paginationVAlign || "both" === this.options.paginationVAlign ? '<div class="fixed-table-pagination"></div>': "", "</div>", "</div>"].join("")),
    ...
    n.prototype.initToolbar = function() {
        ...
        this.options.search && (g = [], g.push('<div class="pull-' + this.options.searchAlign + ' search">', c('', this.options.formatSearch()), "</div>"), this.$toolbar.append(g.join("")), d = this.$toolbar.find(".search input"), d.off("keyup drop").on("keyup drop",
        function(a) {
            clearTimeout(i),
